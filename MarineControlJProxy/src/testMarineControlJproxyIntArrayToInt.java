...
public class testMarineControlJproxyIntArrayToInt {
	...
	public void test() {
		...
		assertEquals("Content should be zero", 0x000000FF, MarineControlJProxy.intArrayToInt(b));
		assertEquals("Content should be zero", 0x0000FF00, MarineControlJProxy.intArrayToInt(c));
		assertEquals("Content should be zero", 0x00FF0000, MarineControlJProxy.intArrayToInt(d));
		assertEquals("Content should be zero", 0xFF000000, MarineControlJProxy.intArrayToInt(e));
		assertEquals("Content should be zero", 0x0000FFFF, MarineControlJProxy.intArrayToInt(f));
		assertEquals("Content should be zero", 0x00FFFFFF, MarineControlJProxy.intArrayToInt(g));
		assertEquals("Content should be zero", 0xFFFFFFFF, MarineControlJProxy.intArrayToInt(h));
		assertEquals("Content should be zero", 0xFFFF0000, MarineControlJProxy.intArrayToInt(i));
		assertEquals("Content should be zero", 0xFFFFFF00, MarineControlJProxy.intArrayToInt(j));
		assertEquals("Content should be zero", 0x0000000A, MarineControlJProxy.intArrayToInt(k));
		assertEquals("Content should be zero", 0x00000A00, MarineControlJProxy.intArrayToInt(l));
		assertEquals("Content should be zero", 0x000A0000, MarineControlJProxy.intArrayToInt(m));
		assertEquals("Content should be zero", 0x0A000000, MarineControlJProxy.intArrayToInt(n));
		assertEquals("Content should be zero", 0x00000A0A, MarineControlJProxy.intArrayToInt(o));
		assertEquals("Content should be zero", 0x000A0A0A, MarineControlJProxy.intArrayToInt(p));
		assertEquals("Content should be zero", 0x0A0A0A0A, MarineControlJProxy.intArrayToInt(q));
		assertEquals("Content should be zero", 0x0A0A0000, MarineControlJProxy.intArrayToInt(r));
		assertEquals("Content should be zero", 0x0A0A0A00, MarineControlJProxy.intArrayToInt(s));

		assertEquals("Content should be zero", 0x000000F0, MarineControlJProxy.intArrayToInt(t));
		assertEquals("Content should be zero", 0x0000F000, MarineControlJProxy.intArrayToInt(u));
